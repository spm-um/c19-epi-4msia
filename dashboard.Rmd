...
ct_tpr <- ifelse(epid_report$mean_tpr[epid_report$state=="Malaysia"]>20, "4",
            ifelse(epid_report$mean_tpr[epid_report$state=="Malaysia"]>4.99, "3",
                   ifelse(epid_report$mean_tpr[epid_report$state=="Malaysia"]>1.99, "2", "1")))
```
 <span style="font-family: Calibri, serif; font-size:12pt">A 7-day incidence rate of </span><span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold;">`r round(epid_report$mean_ir[epid_report$state=="Malaysia"],1)`</span>  <span style="font-family: Calibri, serif; font-size:12pt">confirmed COVID-19 cases per 100,000 population were reported at the National level over the last 7-days </span> <span style="font-family: Calibri, serif; color: blue; font-size:12pt"> (`r format(Sys.Date()-8, '%A, %d %B, %Y')`-`r format(Sys.Date()-1, '%A, %d %B %Y')`)</span> <span tyle="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold"> `r ifelse(epid_report$perc_change_ir[epid_report$state=="Malaysia"]>0, "-an increase", "-a decrease")`</span> <span style="font-family: Calibri, serif; font-size:12pt"> of </span> <span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold"> `r round(epid_report$perc_change_ir[epid_report$state=="Malaysia"],1)`%</span>  <span style="font-family: Calibri, serif; font-size:12pt"> from the previous week. This corresponds to community transmission level `r ct_ir`.<span> <span style="font-family: Calibri, serif; font-size:12pt">A 7-day mortality rate of </span><span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold;">`r round(epid_report$mean_mr[epid_report$state=="Malaysia"],1)`</span>  <span style="font-family: Calibri, serif; font-size:12pt">confirmed COVID-19 mortalities per 100,000 population were reported at the National level over the last 7-days </span> <span style="font-family: Calibri, serif; color: blue; font-size:12pt"> (`r format(Sys.Date()-8, '%A, %d %B, %Y')`-`r format(Sys.Date()-1, '%A, %d %B %Y')`)</span> <span tyle="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold"> `r ifelse(epid_report$perc_change_mr[epid_report$state=="Malaysia"]>0, "an increase", "a decrease")`</span> <span style="font-family: Calibri, serif; font-size:12pt"> of </span> <span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold"> `r round(epid_report$perc_change_mr[epid_report$state=="Malaysia"],1)`%</span>  <span style="font-family: Calibri, serif; font-size:12pt"> from the previous week. This corresponds to community transmission level `r ct_mr`.<span>
  ...
  <span style="font-family: Calibri, serif; font-size:12pt">A test positivity rate of </span><span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold;">`r round(epid_report$mean_tpr[epid_report$state=="Malaysia"],1)`%</span>  <span style="font-family: Calibri, serif; font-size:12pt">was reported at the National level over the last 7-days </span> <span style="font-family: Calibri, serif; color: blue; font-size:12pt"> (`r format(Sys.Date()-8, '%A, %d %B, %Y')`-`r format(Sys.Date()-1, '%A, %d %B %Y')`)</span> <span tyle="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold"> `r ifelse(epid_report$perc_change_tpr[epid_report$state=="Malaysia"]>0, "an increase", "a decrease")`</span> <span style="font-family: Calibri, serif; font-size:12pt"> of </span> <span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold"> `r round(epid_report$perc_change_tpr[epid_report$state=="Malaysia"],1)`%</span>  <span style="font-family: Calibri, serif; font-size:12pt"> from the previous week. This corresponds to community transmission level `r ct_tpr`.<span>  <span style="font-family: Calibri, serif; font-size:12pt">A testing rate of </span> <span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold;">`r round(epid_report$mean_tr[epid_report$state=="Malaysia"],1)` </span> <span style="font-family: Calibri, serif; font-size:12pt"> per 1,000 population, was reported over the same period.</span>  <span style="font-family: Calibri, serif; font-size:12pt"> This corresponds to </span> <span style="font-family: Calibri, serif; font-size:12pt"> `r ifelse(epid_report$perc_change_tr[epid_report$state=="Malaysia"]>0, "an increase", "a decrease")`</span> <span style="font-family: Calibri, serif; font-size:12pt"> of </span> <span style="font-family: Calibri, serif; color: red; font-size:12pt; font-weight: bold"> `r round(epid_report$perc_change_tr[epid_report$state=="Malaysia"],1)`%</span><span style="font-family: Calibri, serif; font-size:12pt"> from the previous week.</span>
...
## Testing
### Latest testing statistics
```{r, echo=FALSE}
renderReactable(testing_tbl)
```

### Trends of testing over time
```{r, echo=FALSE}
line_geo8 = selectInput(inputId = "line_choice_geography8",
                       label = "State",
                        choices = c("Malaysia", "Perlis", "Kedah", "Pulau Pinang", "Perak", "Selangor",
                                    "W.P. Kuala Lumpur", "W.P. Putrajaya", "Negeri Sembilan", "Melaka",
                                    "Johor", "Kelantan", "Terengganu", "Pahang", "Sabah", "Sarawak", "W.P. Labuan"),
...
```{r, echo=FALSE}
renderPlotly({
  geo = ifelse(input$line_choice_geography8 == 'Malaysia', "Malaysia",
               ifelse(input$line_choice_geography8 == 'Perlis', "Perlis",
                      ifelse(input$line_choice_geography8 == 'Kedah', "Kedah",
                             ifelse(input$line_choice_geography8 == 'Pulau Pinang', "Penang",
                                    ifelse(input$line_choice_geography8 == 'Perak', "Perak",
                                           ifelse(input$line_choice_geography8 == 'Selangor', "Selangor",
                                                  ifelse(input$line_choice_geography8 == 'W.P. Kuala Lumpur', "KL",
                                                         ifelse(input$line_choice_geography8 == 'W.P. Putrajaya', "Putrajaya",
                                                                ifelse(input$line_choice_geography8 == 'Negeri Sembilan', "NS",
                                                                       ifelse(input$line_choice_geography8 == 'Melaka', "Melaka",
                                                                              ifelse(input$line_choice_geography8 == 'Johor', "Johor",
                                                                                     ifelse(input$line_choice_geography8 == 'Kelantan', "Kelantan",
                                                                                            ifelse(input$line_choice_geography8 == 'Terengganu', "Terengganu",
                                                                                                   ifelse(input$line_choice_geography8 == 'Pahang', "Pahang",
                                                                                                          ifelse(input$line_choice_geography8 == 'Sabah', "Sabah",
                                                                                                                 ifelse(input$line_choice_geography8 == 'Sarawak', "Sarawak", "Labuan"))))))))))))))))
  
   # build string
  chosen_plot = paste0('test_curve_', geo)
  # parse and evaluate content of the string
  eval(parse(text = chosen_plot)) 
}
)
...
## Variants of concern
```{r class.source="fold-show", echo=FALSE}
line_type5 = selectInput(inputId = "line_choice_type5",
                            label = "Indicator",
                            choices = c("Variant of concern absolute counts", 
                                        "Variant of concern percentages", 
                                        "Comparison of peak variant transmission",
                                        "Genomic Sequencing to case ratio"),
                            selected = "Variant of concern counts")
```
...
```{r class.source="fold-show", echo=FALSE}
renderPlotly(
  if (input$line_choice_type5 == "Variant of concern absolute counts"){
    genomic_voc_abs
  } else if (input$line_choice_type5 == "Variant of concern percentages") {
    genomic_voc_perc
  } else if (input$line_choice_type5 == "Comparison of peak variant transmission") {
    genomic_epi_abs
  }else if (input$line_choice_type5 == "Genomic Sequencing to case ratio") {
    genomic_ratio_abs
  }
)
```
...
## Vaccination
### Comparison of vaccination percentage across states
```{r class.source="fold-show", echo=FALSE}
line_type6 = selectInput(inputId = "line_choice_type6",
                            label = "Age-groups",
                            choices = c("All", 
                                        "Child (<19 years old)", 
                                        "Adult (>18 years old)"),
...
```{r class.source="fold-show", echo=FALSE}
renderPlotly(
  if (input$line_choice_type6 == "All"){
    vax_bar_all
  } else if (input$line_choice_type6 == "Adult (>18 years old)") {
    vax_bar_adult
  } else if (input$line_choice_type6 == "Child (<19 years old)") {
    vax_bar_child
  }
)
```

### Comparison of vaccination percentage across states and time
```{r class.source="fold-show", echo=FALSE}
line_type7 = selectInput(inputId = "line_choice_type7",
                            label = "Age-groups",
                            choices = c("All", 
                                        "Child (<19 years old)", 
                                        "Adult (>18 years old)"),
                            selected = "All")
line_geo9 = selectInput(inputId = "line_choice_geography9",
                       label = "State",
                        choices = c("Malaysia", "Perlis", "Kedah", "Pulau Pinang", "Perak", "Klang valley", 
                                    "Negeri Sembilan", "Melaka", "Johor", "Kelantan", "Terengganu", "Pahang", 
...
```{r, echo=FALSE}
renderPlotly({
  type = ifelse(input$line_choice_type7 == 'All', 'all',
                ifelse(input$line_choice_type7 == 'Child (<19 years old)', 'child', "adult"))
  
  geo = ifelse(input$line_choice_geography9 == 'Malaysia', "Malaysia",
               ifelse(input$line_choice_geography9 == 'Perlis', "Perlis",
                      ifelse(input$line_choice_geography9 == 'Kedah', "Kedah",
                             ifelse(input$line_choice_geography9 == 'Pulau Pinang', "Penang",
                                    ifelse(input$line_choice_geography9 == 'Perak', "Perak",
                                           ifelse(input$line_choice_geography9 == 'Klang', "Klang valley",
                                                                ifelse(input$line_choice_geography9 == 'Negeri Sembilan', "NS",
                                                                       ifelse(input$line_choice_geography9 == 'Melaka', "Melaka",
                                                                              ifelse(input$line_choice_geography9 == 'Johor', "Johor",
                                                                                     ifelse(input$line_choice_geography9 == 'Kelantan', "Kelantan",
                                                                                            ifelse(input$line_choice_geography9 == 'Terengganu', "Terengganu",
                                                                                                   ifelse(input$line_choice_geography9 == 'Pahang', "Pahang",
                                                                                                          ifelse(input$line_choice_geography9 == 'Sabah', "Sabah",
                                                                                                                 ifelse(input$line_choice_geography9 == 'Sarawak', "Sarawak", "Labuan"))))))))))))))

   # build string
  chosen_plot = paste0('vax_curve_', geo, '_', type)
  # parse and evaluate content of the string
  eval(parse(text = chosen_plot)) 
}
)
...
## Case fatality rates & Vaccination
### Comparison of CFR and vaccination rates
```{r, echo=FALSE}
renderReactable(cfr_tbl)
```

### CFR and Vaccination rates across time
```{r class.source="fold-show", echo=FALSE}
line_type8 = selectInput(inputId = "line_choice_type8",
                            label = "Age-group",
                            choices = c("All",
                                        "Child (<18 years old)",
...
```{r class.source="fold-show", echo=FALSE}
renderPlotly(
  if (input$line_choice_type8 == "All"){
    mas_cfr_plot_all
  } else if (input$line_choice_type8 == "Child (<18 years old)") {
    mas_cfr_plot_child
  } else if (input$line_choice_type8 == "Adult (18-59 years old") {
    mas_cfr_plot_adult
  }else if (input$line_choice_type8 == "Elderly (>59 years old)") {
    mas_cfr_plot_elderly
  }
)
```
...
## Mobility
```{r class.source="fold-show", echo=FALSE}
line_geo11 = selectInput(inputId = "line_choice_geography11",
                       label = "State",
                        choices = c("Malaysia", "Perlis", "Kedah", "Pulau Pinang", "Perak", "Selangor",
                                    "W.P. Kuala Lumpur", "W.P. Putrajaya", "Negeri Sembilan", "Melaka",
                                    "Johor", "Kelantan", "Terengganu", "Pahang", "Sabah", "Sarawak", "W.P. Labuan"),
...
```{r, echo=FALSE}
renderPlotly({
  geo = ifelse(input$line_choice_geography11 == 'Malaysia', "Malaysia",
               ifelse(input$line_choice_geography11 == 'Perlis', "Perlis",
                      ifelse(input$line_choice_geography11 == 'Kedah', "Kedah",
                             ifelse(input$line_choice_geography11 == 'Pulau Pinang', "Penang",
                                    ifelse(input$line_choice_geography11 == 'Perak', "Perak",
                                           ifelse(input$line_choice_geography11 == 'Selangor', "Selangor",
                                                  ifelse(input$line_choice_geography11 == 'W.P. Kuala Lumpur', "KL",
                                                         ifelse(input$line_choice_geography11 == 'W.P. Putrajaya', "Putrajaya",
                                                                ifelse(input$line_choice_geography11 == 'Negeri Sembilan', "NS",
                                                                       ifelse(input$line_choice_geography11 == 'Melaka', "Melaka",
                                                                              ifelse(input$line_choice_geography11 == 'Johor', "Johor",
                                                                                     ifelse(input$line_choice_geography11 == 'Kelantan', "Kelantan",
                                                                                            ifelse(input$line_choice_geography11 == 'Terengganu', "Terengganu",
                                                                                                   ifelse(input$line_choice_geography11 == 'Pahang', "Pahang",
                                                                                                          ifelse(input$line_choice_geography11 == 'Sabah', "Sabah",
                                                                                                                 ifelse(input$line_choice_geography11 == 'Sarawak', "Sarawak", "Labuan"))))))))))))))))

   # build string
  chosen_plot = paste0('mobility_curve_', geo)
  # parse and evaluate content of the string
  eval(parse(text = chosen_plot)) 
}
)
